...
%%comparibg the un-normalized and the normalized data
subplot(2,1,1)
plot(X(:,1), X(:,2),'o')
...
%%PCvariance =  this should not be in comments. commented just for
% %%debugging resons
...
figure(6)%  Display the first 100 faces in the dataset
displayData(X(1:100, :));
